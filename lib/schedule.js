...
const OVERRIDES = {
  1: {
    ...
    blocks: [
      "Max push-ups in 1 set (record #)",
      "Max time plank hold (record time)",
      "Max pull-ups OR max dead-hang time (record #/time)",
      "1000m row for time OR 1 mile ruck for time (record time)",
    ],
  ...
  50: {
    ...
    blocks: [
      "Max push-ups in 1 set (compare to Day 1)",
      "Max time plank hold",
      "Max pull-ups OR max dead-hang time",
      "1000m row for time OR 1 mile ruck for time",
    ],
    note: "Same tests as Day 1 — write the numbers side by side and see how far you have come.",
  },
  100: {
    title: "Day 100 — Final Test & Celebration",
    blocks: [
      "Max push-ups in 1 set (compare to Day 1 & 50)",
      "Max time plank hold",
      "Max pull-ups OR max dead-hang time",
      "1000m row for time OR 1 mile ruck for time",
      "Optional: 1-3 mile ruck for time as a capstone effort",
    ],
    note: "100 days done. Compare every number back to Day 1. Take a full rest day tomorrow — you earned it.",
  },
};
